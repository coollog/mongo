...
namespace {
    ...
    unique_ptr<CanonicalQuery> canonicalize(const char* queryStr, const char* sortStr,
                                 const char* projStr) {
        BSONObj queryObj = fromjson(queryStr);
    ...
    unique_ptr<CanonicalQuery> canonicalize(const char* queryStr, const char* sortStr,
        ...
        auto statusWithCQ = CanonicalQuery::canonicalize(ns, queryObj, sortObj,
                                                   projObj,
                                                   skip, limit,
                                                   hintObj,
                                                   minObj, maxObj,
    ...
    protected:
        ...
        void runQueryFull(const BSONObj& query,
            ...
            auto statusWithCQ = CanonicalQuery::canonicalize(ns, query, sort, proj, skip, limit,
                                                             hint, minObj, maxObj, snapshot,
                                                             false); // explain
            ASSERT_OK(statusWithCQ.getStatus());
