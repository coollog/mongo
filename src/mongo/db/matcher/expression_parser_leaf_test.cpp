...
TEST(MatchExpressionParserTest, BitTestMatchExpressionValidArray) {
    ...
    ASSERT_OK(
        MatchExpressionParser::parse(
            BSON("a" << BSON("$bitsAllSet" << BSON_ARRAY(0LL << 1LL << 2LL << 3LL)))).getStatus());
    ASSERT_OK(MatchExpressionParser::parse(
    ...
    ASSERT_OK(MatchExpressionParser::parse(
                  BSON("a" << BSON("$bitsAllClear" << BSON_ARRAY(0LL << 1LL << 2LL << 3LL))))
                  .getStatus());
    ASSERT_OK(MatchExpressionParser::parse(
    ...
    ASSERT_OK(
        MatchExpressionParser::parse(
            BSON("a" << BSON("$bitsAnySet" << BSON_ARRAY(0LL << 1LL << 2LL << 3LL)))).getStatus());
    ASSERT_OK(MatchExpressionParser::parse(
    ...
    ASSERT_OK(MatchExpressionParser::parse(
                  BSON("a" << BSON("$bitsAnyClear" << BSON_ARRAY(0LL << 1LL << 2LL << 3LL))))
                  .getStatus());
    ASSERT_OK(MatchExpressionParser::parse(
