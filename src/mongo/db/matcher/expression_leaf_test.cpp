...
TEST(BitTestMatchExpression, DoesNotMatchOther) {
    ...
    BSONObj notMatch7 = fromjson("{a: ObjectId('000000000000000000000000')}");  // OID
    BSONObj notMatch8 = fromjson("{a: Date(54)}");                              // Date
...
TEST(BitTestMatchExpression, MatchBinaryWithLongBitMask) {
    ...
    std::vector<int> bitPositions = balls.copyBitPositions();
